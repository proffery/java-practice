...
Please, implement the method `intersection(Line)` in class [`Line`](src/main/java/com/epam/training/student_dmitry_shamko/Line.java).
It  must return a [`Point`](src/main/java/com/epam/training/student_dmitry_shamko/Point.java) of intersection of two lines.
...
You may check your result in class [`Main`](src/main/java/com/epam/training/student_dmitry_shamko/Main.java).
